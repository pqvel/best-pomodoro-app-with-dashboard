...
const SectionCart: FC<SectionCartProps> = ({
  title,
  descr,
  leftTime,
  editHanlder,
  ...
  return (
    <div className="dashboard__cart">
      ...
      <span>{leftTime}</span>
      <button className="dashboard__cart-settings" onClick={editHanlder}>
        :
      </button>
    </div>
  );
  ...
  return (
    <div className="dashboard__section flex flex-col">
      ...
      <div className="flex gap-2">
        <button className="button button-black" disabled>
          Добавить раздел
        </button>
