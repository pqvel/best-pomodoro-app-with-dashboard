  ...
  <MainTemplate>
    <section className=" flex flex-col gap-4">
      ...
      <p>
        ...
        знают ответ на этот вопрос: по данным Google Trends за 2019 год мы
        искали «pomodoro» в 3 раза чаще, чем «тайм-менеджмент».
        Pomodoro — техника управления временем, для которой достаточно
        смартфона, блокнота и ручки. Worksection попробовал разобраться, как
        быть успешным с помощью кухонного таймера, кому Pomodoro вряд ли
        понравится, и что делать, если в офисе вас отвлекают от «помидорного»
        графика.
      </p>
      ...
      <ol className="pl-5 flex flex-col gap-3">
        <li className="list-decimal">
          ...
          отвлечься и попасть в режим многозадачности, потому что вы
          знаете — через 25 минут будет перерыв.
        </li>
        <li className="list-decimal">
