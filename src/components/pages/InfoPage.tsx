...
const lecture = {
  title: "Глава 1. Асинхронное прогарммирование"
  id: 1
  blocks: [
    {
      title: "Введение в асинхронное программирование",
      id: 1,
      paragraphs: [
        { id: 1, text: "дщклацаоцщшаоцшщашщцаоцац"},
        { id: 2, text: "дщклацаоцщшаоцшщашщцаоцац"}
        { id: 3, text: "дщклацаоцщшаоцшщашщцаоцац"}
        { id: 4, text: "дщклацаоцщшаоцшщашщцаоцац"}
        { id: 5, text: "дщклацаоцщшаоцшщашщцаоцац"}
      ]
    },
    {
      title: "Введение в асинхронное программирование",
...
const Main = () => {
  ...
  return (
    <main>
      {dataFronServer.map(({type, data}) => {
        if (type === "lecture") {
          return <Lecture key={data.id} lecture={data} />
        }
      })}
    </main>
  )
...
const Lecture = ({ lecture }) => {
  return (
    <div>
      <h2>{lecture.title}</h2>
      {lecture.blocks.map(({title, paragraphs, id}) => {
        return (
          <div id={id}>
            <h3>{title}</h3>
